param sites_resolve_domain_name string = 'resolve-domain'
...
resource sites_resolve_domain_name_resource 'Microsoft.Web/sites@2023-01-01' = {
  name: sites_resolve_domain_name
  ...
  properties: {
    ...
    hostNameSslStates: [
      {
        name: '${sites_resolve_domain_name}.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Standard'
      }
      {
        name: '${sites_resolve_domain_name}.scm.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Repository'
      }
    ]
...
resource sites_resolve_domain_name_ftp 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2023-01-01' = {
  parent: sites_resolve_domain_name_resource
  name: 'ftp'
  location: 'West Europe'
  tags: {
    resource: 'resolve-domain'
...
resource sites_resolve_domain_name_scm 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2023-01-01' = {
  parent: sites_resolve_domain_name_resource
  name: 'scm'
  location: 'West Europe'
  tags: {
...
resource sites_resolve_domain_name_web 'Microsoft.Web/sites/config@2023-01-01' = {
  parent: sites_resolve_domain_name_resource
  name: 'web'
  location: 'West Europe'
  tags: {
...
resource sites_resolve_domain_name_Resolve 'Microsoft.Web/sites/functions@2023-01-01' = {
  parent: sites_resolve_domain_name_resource
  name: 'Resolve'
  location: 'West Europe'
  properties: {
...
resource sites_resolve_domain_name_sites_resolve_domain_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2023-01-01' = {
  parent: sites_resolve_domain_name_resource
  name: '${sites_resolve_domain_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
